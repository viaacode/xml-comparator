...
public class MultipleAttributeChangesTest extends BaseTest {
    final static String CONTROL_FILE_PATH = "test-data/BaseFile.xml";
    final static String TEST_FILE_PATH = "test-data/diff/attribute-change/MultipleAttributeChangesFile.xml";
    ...
    @Test
    @DisplayName("Test multiple attribute differences")
    public void testOneTextValueDifference() {
        ...
        assertEquals(2, comparisonDetail.getAttributeDifferences().size(), "There should be 2 attribute differences");
    }
}
